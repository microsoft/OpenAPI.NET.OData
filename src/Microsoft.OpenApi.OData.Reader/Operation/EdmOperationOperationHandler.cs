...
namespace Microsoft.OpenApi.OData.Operation
{
    ...
    internal abstract class EdmOperationOperationHandler : OperationHandler
    {
        ...
        /// <summary>
        /// Generates the tag name for the operation. Adds Action or Function name to the tag name if the operation is an action or function.
        /// </summary>
        ...
        {            
            ...
            switch (targetSegment)
            {
                ...
                // Previous segment could be a navigation property or a navigation source segment
